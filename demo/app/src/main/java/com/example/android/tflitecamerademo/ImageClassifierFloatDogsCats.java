 ...
 */
public class ImageClassifierFloatDogsCats extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierFloatDogsCats(Activity activity) throws IOException {
    super(activity);
