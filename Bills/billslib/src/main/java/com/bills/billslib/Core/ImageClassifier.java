...
public abstract class ImageClassifier {
  ...
  public Bitmap classifyFrame(Bitmap bitmap, SpannableStringBuilder builder) {
...
//    }
    ...
    builder.append(span);
    return converToBitmap(getArray(4));
  }

  private Bitmap converToBitmap(float[][][][] output){
...
//        int valueToReplicate = ((Float)output[0][i][j][0]).intValue();
    ...
    return Bitmap.createBitmap(convertedOutput, 480, 480, Bitmap.Config.ARGB_8888);
  }
